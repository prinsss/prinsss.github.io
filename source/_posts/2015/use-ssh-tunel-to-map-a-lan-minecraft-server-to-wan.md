...
唔，似乎刷新了窝博客中最长标题记录呢 ![表情](https://img.prin.studio/images/2015/09/2015-09-19_15-53-31.jpg)
...
![NAT port forwarding](https://img.prin.studio/images/2015/12/2015-12-19_12-23-33.png)

这是普通的路由器端口映射原理，下面是花生壳 “端口映射” 原理：

<!--more-->

![oray portforwarding](https://img.prin.studio/images/2015/12/2015-12-19_12-43-25.png)
...
![ping data](https://img.prin.studio/images/2015/12/2015-12-19_13-52-50.png)

![ping server](https://img.prin.studio/images/2015/12/2015-12-19_15-43-22.png)
...
![1](https://img.prin.studio/images/2015/12/2015-12-19_13-57-29.png)
...
![ssh -r man page](https://img.prin.studio/images/2015/12/2015-12-19_14-12-11.png)
...
![2](https://img.prin.studio/images/2015/12/2015-12-19_14-17-34.png)
...
![gateway ports man page](https://img.prin.studio/images/2015/12/2015-12-19_14-28-12.png)
...
![sshd_config](https://img.prin.studio/images/2015/12/2015-12-19_14-33-42.png)

保存后，重载 sshd （`$ service sshd reload`），再次执行上述命令，是不是发现端口已经监听在 0.0.0.0 上了呢？

而且 MC 客户端也可以正常访问到了~

![mc succeed](https://img.prin.studio/images/2015/12/2015-12-19_14-43-21.png)
...
![ssh -f](https://img.prin.studio/images/2015/12/2015-12-19_15-06-42.png)
...
![1](https://img.prin.studio/images/2015/12/2015-12-19_15-24-27.png)

这个应该都会吧，然后进 SSH – Tunel：

![2](https://img.prin.studio/images/2015/12/2015-12-19_15-25-10.png)

最后点 Add 按钮添加规则，去 Session 页，保存成一个配置集，以后就可以直接 Open 了。

![putty](https://img.prin.studio/images/2015/12/2015-12-19_15-28-35.png)
